...
mod tests {
    ...
    use agent_driver_rs::provider::{CompletionRequest, Provider as _, ProviderContext};
    use agent_driver_rs::streaming::{
        CompletionMetadata, CompletionStream, ContentBlockType, StopReason, StreamDelta,
