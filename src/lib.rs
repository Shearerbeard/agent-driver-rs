...
#[cfg(feature = "phoenix")]
pub use otel::{
    AgentLoopSpan, SessionOperationSpan, SpanKind as OpenInferenceSpanKind, ToolSpan, attr,
    get_tracer, get_tracer_provider, init_phoenix, init_tracer_provider, shutdown_phoenix,
};
